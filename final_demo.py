#!/usr/bin/env python3
"""
Final demo showing agent system output
"""
...
def show_final_demo():
    ...
    print("   Issues (Nodes):")
    print("   Reddit: BART delays [SOMA, Transportation]")
    print("   |")
    print("   | Geographic Relationship (0.73)")
    print("   |")
    print("   311: Blocked driveway [Mission, Parking]")
    print("   |")
    print("   | Temporal Relationship (0.65)")
    print("   |")
    print("   Reddit: Homeless camp [Mission, Homelessness]")
    print("   |")
    print("   |")
    print("   311: Street cleaning [Richmond, Litter]")
